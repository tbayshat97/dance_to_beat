                ...
                <div class="card-content">
                    ...
                    <div id="html-view-validations">
                        <form class="formValidate0" id="formValidate0" method="POST"
                            action="{{ route('admin.course.store') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                ...
                                <div class="input-field col s12 m6 l6">
                                    {!! Form::select('dance', $dances, old('dance')) !!}
                                    <label>{{ __('Dance') }}</label>
                                </div>

                                <div class="input-field col s12 m6 l6">
                                    {!! Form::select('artist', $artists, old('artist')) !!}
                                ...
                                <div class="input-field input-field col s12 ">
                                    ...
                                    <p>
                                        <label>
                                        <input name="is_published" @if (old('is_published'))
                                            checked
                                        @endif type="checkbox">
                                        <span>Publish</span>
                                        </label>
