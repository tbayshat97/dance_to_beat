                                ...
                                <table id="page-length-option" class="display">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <ul>
                                                    @foreach ($item->permissions as $single_perm)
                                                    <li>{{ $single_perm->name }}</li>
                                                @endforeach
                                                </ul>
                                            </td>
                                            <td class="center-align">
                                                <a href="{{ route('admin.roles.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
                                                <a href="#modalDelete" onclick="setRoute('{{ $item }}', '{{ route('admin.roles.destroy', $item) }}')" class="modal-trigger btn-floating red pulse"><i class="material-icons">delete</i></a>
                                            </td>
                                            </tr>
                                        @endforeach
                                    </tbody>
