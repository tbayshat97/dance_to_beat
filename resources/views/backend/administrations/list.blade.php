                                    ...
                                    <tbody>
                                        @foreach ($users as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <ul>
                                                        @foreach ($item->roles as $single_role)
                                                        <li>{{ $single_role->name }}</li>
                                                        @endforeach
                                                    </ul>
                                                </td>
                                                <td>
                                                ...
                                                <td class="center-align">
                                                    <a href="{{ route('admin.administration.show', $item) }}" class="btn-floating cyan pulse"><i class="material-icons">edit</i></a>
