    ...
    <nav
        ...
        <div class="nav-wrapper">
                ...
                <li>
                    <a class="waves-effect waves-block waves-light profile-button" href="javascript:void(0);"
                        ...
                        <span class="avatar-status avatar-online">
                            @php
                            $accountImage = auth('artist')->user()->profile->getProfileImage() ? asset(auth('artist')->user()->profile->getProfileImage()) :
            ...
            <ul class="dropdown-content" id="profile-dropdown">
                <li>
                    <a class="grey-text text-darken-1" href="{{ route('artist.profile') }}">
                ...
                <li>
                    <a class="grey-text text-darken-1" href="{{ route('artist.logout') }}">
