<aside
    ...
    <div class="brand-sidebar">
        <h1 class="logo-wrapper">
            <a class="brand-logo darken-1" href="{{asset('/artist')}}">
    ...
    <ul class="sidenav sidenav-collapsible leftside-navigation collapsible sidenav-fixed menu-shadow" id="slide-out"
        ...
        @if(!empty($menuDataArtist[0]) && isset($menuDataArtist[0]))
        @foreach ($menuDataArtist[0]->menu as $menu)
        ...
        <li class="bold {{(request()->is($menu->url.'*')) ? 'active' : '' }}">
            ...
            @include('panels-artist.submenu', ['menu' => $menu->submenu])
            @endif
        </li>
        @endif
        @endforeach
