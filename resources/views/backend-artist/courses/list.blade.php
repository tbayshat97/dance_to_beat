            ...
            if (willDelete) {
                $.ajax({
                    ...
                    success: function (response) {
                        setTimeout(goTo("{{ route('artist.course.live.list') }}"), 2000);
                    }
                });
            } else {
